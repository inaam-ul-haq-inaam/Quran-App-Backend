...
SURAH_DB = {
    ...
    "imran": 3, "aal e imran": 3,
    "nisa": 4, "an nisa": 4, "neesa": 4,
    "maidah": 5, "maida": 5,
    "anam": 6, "anaam": 6,
    "araf": 7, "aaraf": 7,
    "anfal": 8, "anfaal": 8,
    "tawbah": 9, "tawba": 9, "tobah": 9,
    "yunus": 10, "younus": 10,
    ...
    "zukhruf": 43,
    "dukhan": 44,
    "jathiyah": 45, "jasiya": 45,
    "ahqaf": 46,
    "muhammad": 47, "mohammad": 47,
    "fath": 48, "fatah": 48,
    "hujurat": 49,
    "qaf": 50, "qaaf": 50,
    ...
    "shams": 91,
    "layl": 92, "lail": 92,
    "duha": 93, "zuha": 93, "wadduha": 93,
    "sharh": 94, "inshirah": 94, "nashrah": 94,
    "tin": 95, "teen": 95, "watteen": 95,
    "alaq": 96,
    "qadr": 97, "qadar": 97,
    ...
    "nasr": 110,
    "masad": 111, "lahab": 111,
    "ikhlas": 112, "ahad": 112, "qul hu wallah": 112,
    "falaq": 113,
    "nas": 114, "naas": 114
}
...
def find_surah_id(text: str):
    ...
    best_match, score = process.extractOne(text, SURAH_DB.keys(), scorer=fuzz.partial_ratio)
    
    if score >= 80:
        print(f"📖 Surah Detect: '{best_match}' (ID: {SURAH_DB[best_match]}) Score: {score}%")
...
def find_reciter_id(text: str):
    ...
    best_match, score = process.extractOne(text, RECITER_DB.keys(), scorer=fuzz.partial_ratio)
    
    if score >= 80:
        print(f"🎤 Reciter Detect: '{best_match}' Score: {score}%")
